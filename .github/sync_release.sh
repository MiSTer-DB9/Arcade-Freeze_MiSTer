...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Freeze_MiSTer.git"
CORE_NAME=(Arcade-freeze)
...
UPSTREAM_CORE_NAME=(Arcade-freeze)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-freeze.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-freeze.rbf)
